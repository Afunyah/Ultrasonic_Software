function voxelPlot_c(mat, fig, varargin)
...
elseif rem(nargin - num_req_input_variables, 1)
...
[IMAGE_3D_DATA] = image3Ddata_c(mat);  
...
hp2 = patch('Faces', M_faces, 'Vertices', M_vertices, 'EdgeColor', 'black','FaceColor',color_map);  
